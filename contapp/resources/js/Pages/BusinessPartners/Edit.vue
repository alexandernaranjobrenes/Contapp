...
const form = useForm({
    ...
    economic_activity_code: props.partner.economic_activity_code ?? '',
    phone: props.partner.phone ?? '',
    contact_name: props.partner.contact_name ?? '',
    partner_since: props.partner.partner_since ?? '',
...
function submit() {
    form.put(route('business-partners.update', props.partner.id));
}
</script>
